...
> **PROC reference:** `COMPRUN.jcl` uses the `MYCOMPGO` catalogued procedure for compilation and execution. Make sure `MYCOMPGO` is available in your system's `PROCLIB` before submitting.
